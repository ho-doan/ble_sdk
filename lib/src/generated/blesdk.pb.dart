...
class ScanModel extends $pb.GeneratedMessage {
  ...
  factory ScanModel.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ScanModel.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ScanModel copyWith(void Function(ScanModel) updates) =>
      super.copyWith((message) => updates(message as ScanModel))
          as ScanModel; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static ScanModel getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ScanModel>(create);
...
class ConnectModel extends $pb.GeneratedMessage {
  ...
  factory ConnectModel.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ConnectModel.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ConnectModel copyWith(void Function(ConnectModel) updates) =>
      super.copyWith((message) => updates(message as ConnectModel))
          as ConnectModel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ConnectModel create() => ConnectModel._();
  ConnectModel createEmptyInstance() => create();
  static $pb.PbList<ConnectModel> createRepeated() =>
      $pb.PbList<ConnectModel>();
  @$core.pragma('dart2js:noInline')
  static ConnectModel getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ConnectModel>(create);
...
class BluetoothBLEModel extends $pb.GeneratedMessage {
  ...
  factory BluetoothBLEModel.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BluetoothBLEModel.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BluetoothBLEModel copyWith(void Function(BluetoothBLEModel) updates) =>
      super.copyWith((message) => updates(message as BluetoothBLEModel))
          as BluetoothBLEModel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BluetoothBLEModel create() => BluetoothBLEModel._();
  BluetoothBLEModel createEmptyInstance() => create();
  static $pb.PbList<BluetoothBLEModel> createRepeated() =>
      $pb.PbList<BluetoothBLEModel>();
  @$core.pragma('dart2js:noInline')
  static BluetoothBLEModel getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BluetoothBLEModel>(create);
...
class Log extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Characteristic>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'characteristic',
        subBuilder: Characteristic.create)
    ..hasRequiredFields = false;
  ...
  Log copyWith(void Function(Log) updates) =>
      super.copyWith((message) => updates(message as Log))
          as Log; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set characteristic(Characteristic v) {
    setField(2, v);
  }
...
class Services extends $pb.GeneratedMessage {
  ...
  Services copyWith(void Function(Services) updates) =>
      super.copyWith((message) => updates(message as Services))
          as Services; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Characteristic extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<CharacteristicProperties>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'properties',
        $pb.PbFieldType.KE,
        valueOf: CharacteristicProperties.valueOf,
        enumValues: CharacteristicProperties.values,
        defaultEnumValue: CharacteristicProperties.NONE)
    ..aOS(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory Characteristic.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Characteristic.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Characteristic copyWith(void Function(Characteristic) updates) =>
      super.copyWith((message) => updates(message as Characteristic))
          as Characteristic; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Characteristic create() => Characteristic._();
  Characteristic createEmptyInstance() => create();
  static $pb.PbList<Characteristic> createRepeated() =>
      $pb.PbList<Characteristic>();
  @$core.pragma('dart2js:noInline')
  static Characteristic getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Characteristic>(create);
...
class CharacteristicValue extends $pb.GeneratedMessage {
  ...
  factory CharacteristicValue.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CharacteristicValue.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CharacteristicValue copyWith(void Function(CharacteristicValue) updates) =>
      super.copyWith((message) => updates(message as CharacteristicValue))
          as CharacteristicValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CharacteristicValue create() => CharacteristicValue._();
  CharacteristicValue createEmptyInstance() => create();
  static $pb.PbList<CharacteristicValue> createRepeated() =>
      $pb.PbList<CharacteristicValue>();
  @$core.pragma('dart2js:noInline')
  static CharacteristicValue getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CharacteristicValue>(create);
